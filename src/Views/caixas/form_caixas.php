  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="javascript:void(0)" hx-get="/api/caixas" hx-target="#content_main_page" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Caixas de atendimento</a>
      </div>
    </li>
...
<form class="max-w-xl mx-auto py-5 px-5 mx-auto bg-gray-50 rounded-lg dark:bg-gray-800" hx-post="/api/caixas" hx-target="#content_main_page">
  <input type="hidden" name="id" value="<?= $caixa['id'] ?? '' ?>">
  <div class="mb-5">
    <label for="caixa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Caixa</label>
