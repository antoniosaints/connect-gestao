  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="javascript:void(0)" hx-get="<?=APP_URL?>/caixas" hx-push-url="true" hx-target="#content_main_page" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Caixas de atendimento</a>
      </div>
    </li>
