    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="javascript:void(0)" hx-get="<?=APP_URL?>/rifas" hx-target="#content_main_page" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Rifas</a>
            </div>
        </li>
...
<form class="max-w-xl mx-auto py-5 px-5 mx-auto bg-gray-50 rounded-lg dark:bg-gray-800" hx-post="<?=APP_URL?>/rifas" hx-target="#content_main_page" hx-swap="outerHTML">
